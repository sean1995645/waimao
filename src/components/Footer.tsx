        ...
        <div className="grid grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-8 md:gap-6 mb-8 md:mb-6">
          ...
          <div className="motion-fade-up animation-delay-200">
            ...
            <div className="flex gap-4 md:gap-3">
              <a href="#" className="text-white no-underline transition-all duration-300 text-base md:text-sm hover:text-hn-accent hover:-translate-y-0.5">{intl.formatMessage({ id: 'footer.facebook' })}</a>
              <a href="#" className="text-white no-underline transition-all duration-300 text-base md:text-sm hover:text-hn-accent hover:-translate-y-0.5">{intl.formatMessage({ id: 'footer.linkedin' })}</a>
            </div>
          </div>
        </div>
