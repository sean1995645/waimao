    ...
    <div className="inner-page w-full bg-hn-surface">
      ...
      <section className="relative overflow-hidden bg-hn-primary py-16 text-white lg:py-24">
        <div className="relative mx-auto grid max-w-[1200px] gap-10 px-5 lg:grid-cols-[minmax(0,1.05fr)_420px] lg:items-center max-md:px-4">
          <div>
            ...
            <div className="motion-fade-up animation-delay-300 mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {productStats.map((item) => (
                <div key={item.label} className="rounded-xl border border-white/10 bg-white/5 px-4 py-4">
                  <p className="text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-gray-300">{item.label}</p>
            ...
            <div className="motion-fade-up animation-delay-500 mt-8 flex flex-wrap gap-3 max-md:flex-col">
              <button
                ...
                className={`inline-flex items-center justify-center rounded-lg px-6 py-3 text-[0.92rem] font-semibold transition-all duration-200 ${
                  isSelected
                    ? 'bg-hn-accent text-white hover:bg-hn-accent-strong'
                    : 'bg-white text-hn-primary hover:-translate-y-0.5 hover:shadow-lg'
                }`}
              >
          ...
          <div className="motion-fade-left relative">
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl backdrop-blur-md max-md:rounded-xl">
              <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/10 p-2">
                <img
                  src={product.image}
      ...
      <section className="mx-auto grid max-w-[1200px] gap-8 px-5 py-12 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start max-md:px-4 max-md:py-8">
        <div className="space-y-8">
          <div className="motion-fade-up rounded-2xl border border-hn-border bg-white p-7 shadow-sm max-md:rounded-xl max-md:p-5">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {productStats.map((item) => (
                <div key={item.label} className="rounded-xl border border-hn-border bg-hn-surface-soft px-5 py-5">
          ...
          <div className="motion-fade-up animation-delay-150 rounded-2xl border border-hn-border bg-white p-7 shadow-sm max-md:rounded-xl max-md:p-5">
            <p className="text-[0.76rem] font-semibold uppercase tracking-[0.18em] text-[#6d8298]">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {capabilityCards.map((item) => (
                <div key={item.title} className="rounded-xl border border-hn-border bg-hn-surface-soft p-5">
                  <div className="mb-4 h-10 w-10 rounded-lg bg-hn-surface" />
        ...
        <aside className="motion-fade-left space-y-5 lg:sticky lg:top-24">
          <div className="overflow-hidden rounded-2xl border border-hn-border bg-hn-surface-soft p-6 shadow-sm max-md:rounded-xl max-md:p-5">
            <p className="text-[0.76rem] font-semibold uppercase tracking-[0.18em] text-[#6d8298]">
            ...
            <div className="mt-6 space-y-3">
              <button
                type="button"
                onClick={handleToggleInquiry}
                className={`inline-flex w-full items-center justify-center rounded-lg px-5 py-3 text-[0.92rem] font-semibold transition-all duration-200 ${
                  isSelected
                    ? 'bg-hn-accent text-white hover:bg-hn-accent-strong'
                    : 'bg-hn-primary text-white hover:bg-hn-secondary'
                }`}
              >
          ...
          <div className="motion-fade-left animation-delay-200 rounded-2xl border border-hn-border bg-white p-6 shadow-sm max-md:rounded-xl max-md:p-5">
            <p className="text-[0.76rem] font-semibold uppercase tracking-[0.18em] text-[#6d8298]">
